...
// the vendored assets: node scripts/import-hold-shapes.mjs BOARDSHESH_REPO GRIP_REPO
...
const boards=JSON.parse(readFileSync(new URL('../site/boards.json',import.meta.url))).boards;
