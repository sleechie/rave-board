...
import { buildPoints,footprint,frameFor,PATTERNS } from '../site/patterns.mjs';
import { EFFECTS,TOUR,makeFrame,mapPoints } from '../site/effects.mjs';
import { encodeFrame,quantize } from '../site/protocol.mjs';
